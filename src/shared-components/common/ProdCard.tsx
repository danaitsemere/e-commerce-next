  ...
  return (
    <div className="bg-white rounded-lg shadow p-4 flex flex-col group hover:shadow-lg transition">
      <div className="relative">
        ...
        />
        {isNew && (
          <span className="absolute top-2 left-2 bg-green-500 text-xs text-white px-2 py-1 rounded">
            NEW
          </span>
        )}
      </div>
      ...
      <div className="flex items-center gap-1 mb-2">
        {Array.from({ length: 5 }, (_, i) => (
          <svg
            ...
            width="14"
            height="14"
            fill={i < rating ? "#FFAD33" : "#E0E0E0"}
            viewBox="0 0 14 14"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path d="M7 0l2 5h5l-4 3 2 5-4-3-4 3 2-5-4-3h5z" />
          </svg>
        ))}
